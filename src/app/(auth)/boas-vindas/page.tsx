      ...
      <div className="w-full max-w-3xl bg-slate-950/60 backdrop-blur-2xl rounded-[24px] shadow-2xl border border-white/10 overflow-hidden flex flex-col relative z-10 animate-fade-in">
        ...
        <div className="p-8 md:p-12 flex flex-col items-center text-center">
          ...
          <div className="relative mb-8">
            ...
            <span
              className="material-symbols-outlined text-primary/60 absolute -top-2 -right-6 text-2xl animate-bounce-slow"
              style={{ animationDelay: '0.1s' }}
            >
              flight_takeoff
            </span>
            <span
              className="material-symbols-outlined text-primary/60 absolute bottom-0 -left-8 text-2xl animate-bounce-slow"
          ...
          <div className="w-full max-w-2xl bg-black/20 backdrop-blur-md rounded-[20px] p-6 border border-white/5 mb-10 shadow-inner">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { icon: 'person', label: 'Complete seu Perfil' },
                { icon: 'upload_file', label: 'Envie seus documentos' },
                { icon: 'support_agent', label: 'Fale com sua consultora' },
              ].map(item => (
                <div key={item.icon} className="bg-black/40 rounded-xl p-4 border border-white/10 shadow-sm flex flex-col items-center text-center hover:bg-white/10 hover:border-white/20 transition-all group cursor-default">
                  <div className="w-12 h-12 rounded-full bg-black/40 border border-white/10 flex items-center justify-center mb-3 group-hover:bg-primary/20 group-hover:border-primary/30 transition-colors shadow-sm">
                    <span className="material-symbols-outlined text-white/80 group-hover:text-primary text-xl transition-colors">{item.icon}</span>
                  </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            ...
            >
              <span className="material-symbols-outlined text-xl text-gray-400 group-hover:text-white transition-colors">map</span>
              Explorar Guia
            </Link>
            <Link
