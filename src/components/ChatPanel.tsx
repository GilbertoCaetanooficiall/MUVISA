...
function ChatPanel({ onClose }: { onClose: () => void }) {
    ...
    return (
        ...
        <div className="w-full max-w-sm h-full bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800 shadow-2xl flex flex-col pointer-events-auto relative">
            {/* Header */}
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-4 space-y-6 bg-background-light dark:bg-slate-900/50">
                {/* Date separator */}
