export default function NextSteps() {
    return (
        <div className="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col h-full">
            ...
            <div className="flex flex-col gap-4 flex-1">
                <div className="flex gap-4 items-start p-4 rounded-lg bg-background-light dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                ...
                <div className="flex gap-4 items-start p-4 rounded-lg bg-background-light dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 opacity-60">
                    <div className="mt-0.5">
