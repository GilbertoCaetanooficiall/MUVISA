    ...
    <Section icon="person" title="Profile Information">
      ...
      <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
        <div className="relative group flex-shrink-0">
          ...
          <button className="absolute bottom-0 right-0 bg-primary text-white p-1.5 rounded-full border-2 border-white dark:border-slate-800 shadow-lg">
...
export function SecuritySettings() {
  return (
    <Section icon="security" title="Security & Password">
...
const notifPrefs = [
  ...
  { icon: 'send_to_mobile', iconBg: 'bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400', title: 'Push Notifications',    desc: 'Instant alerts on your browser or mobile device.',             on: false },
  { icon: 'system_update',  iconBg: 'bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400',   title: 'Application Updates',   desc: 'Notifications about software changes and fixes.',              on: true  },
  { icon: 'chat_bubble',    iconBg: 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400', title: 'New Message Alerts', desc: 'Receive alerts when you get direct messages.',             on: true  },
];

export function NotificationSettings() {
  return (
    <Section icon="notifications_active" title="Notification Preferences">
...
export function AppPreferences() {
  return (
    <Section icon="display_settings" title="App Preferences">
