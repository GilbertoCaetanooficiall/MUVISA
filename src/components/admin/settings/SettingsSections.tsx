  ...
  return (
    <Section icon={User} title="Informações do Perfil">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[
          { label: 'Primeiro Nome',    type: 'text',     value: 'Alex',                    readOnly: false },
          { label: 'Apelido',     type: 'text',     value: 'Rivera',                  readOnly: false },
          { label: 'Endereço de Email', type: 'email',    value: 'alex.rivera@muvisa.com',   readOnly: false },
          { label: 'Número de Telefone',  type: 'tel',      value: '+1 (555) 0123-4567',       readOnly: false },
    ...
    <Section icon={Shield} title="Segurança e Palavra-passe">
      <div className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { label: 'Palavra-passe Atual',   placeholder: '',                type: 'password', value: '············' },
            { label: 'Nova Palavra-passe',       placeholder: 'Nova palavra-passe',     type: 'password', value: '' },
            { label: 'Confirmar Nova Palavra-passe', placeholder: 'Repetir palavra-passe', type: 'password', value: '' },
...
const notifPrefs = [
  { icon: Mail,           iconBg: 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400',     title: 'Notificações por Email',  desc: 'Receba atualizações sobre a atividade via email.',                        on: true  },
  { icon: Smartphone,      iconBg: 'bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400', title: 'Notificações Push',    desc: 'Alertas instantâneos no seu navegador ou dispositivo móvel.',             on: false },
  { icon: RefreshCw,       iconBg: 'bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400',   title: 'Atualizações de Candidatura',   desc: 'Notificações sobre alterações e correções de software.',              on: true  },
  { icon: MessageCircle,   iconBg: 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400', title: 'Alertas de Novas Mensagens', desc: 'Receba alertas quando receber mensagens diretas.',             on: true  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <select className="w-full bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-slate-700 rounded-lg px-4 py-2.5 text-sm appearance-none focus:ring-2 focus:ring-primary/20 outline-none text-slate-900 dark:text-white" defaultValue="pt">
