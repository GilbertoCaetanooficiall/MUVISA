export default function ProcessStages() {
    return (
        <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-md border border-primary/30 ring-1 ring-primary/10 overflow-hidden relative">
            ...
            {/* Etapa 4 - Pendente */}
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden opacity-70">
                <div className="p-5 flex gap-4">
                    <div className="flex flex-col items-center gap-2">
