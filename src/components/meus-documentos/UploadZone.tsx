    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div
                ...
                className={`bg-white dark:bg-slate-900 rounded-xl p-8 border-2 border-dashed transition-all cursor-pointer group flex flex-col items-center justify-center text-center gap-4 select-none
          ${isDragging
