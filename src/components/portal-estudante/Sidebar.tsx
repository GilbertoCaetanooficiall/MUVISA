...
export default function Sidebar() {
    ...
    const navLinks = [
        ...
        { href: "/portal-estudante/meu-processo", label: "Meu Processo", icon: "work" },
        { href: "/portal-estudante/meus-documentos", label: "Meus Documentos", icon: "folder_open" },
        { href: "/portal-estudante/pagamentos", label: "Pagamentos", icon: "credit_card" },
        { href: "/portal-estudante/suporte", label: "Suporte", icon: "support_agent" },
    ];
