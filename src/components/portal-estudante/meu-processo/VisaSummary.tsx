    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
            ...
            <div className="bg-primary/5 rounded-lg p-4 mb-4 border border-primary/10">
                ...
                <h4 className="text-xl font-bold text-primary">Visto de Residência</h4>
                <p className="text-xs text-primary/70 mt-1">Estudo, Estágio ou Voluntariado (D4)</p>
            </div>
            <div className="space-y-4 pt-2">
                <div>
                    ...
                    <p className="text-[10px] text-slate-400 mt-1 text-right">Atualizado hoje pela AIMA</p>
                </div>
